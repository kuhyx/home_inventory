...
# ============================================================================
# Fail if any file in this repo exceeds the shared 250-line cap.
#
# Thin delegate to the shared gate in ~/src/utils, which owns the cap and the
# exemption list (generated files, markup, data). Copying that logic here is
# what lets one repo's idea of "too long" drift from every other repo's -- so
# this script only locates the shared checker and forwards its arguments.
#
# Usage:
